...
const zh = {
    ...
    'profile.speedByLengthDesc': '速度分以你同长度档耗时的中位数为参照；每档不足 5 条计时样本时回退按单词长度估算',
...
const en: Record<TranslationKey, string> = {
    ...
    'profile.speedByLengthDesc': 'Speed scoring compares each word against your median typing time for the same length group; falls back to a length estimate until a group has 5 samples',
